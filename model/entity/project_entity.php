...
function updateProject(int $id, string $title, string $picture, string $description, int $price, string $dateStart, string $dateEnd) {
    global $connection;

    $query = "UPDATE project SET title = :title, price = :price, picture = :picture, description = :description, date_start = :date_start, date_end = :date_end WHERE id = :id";
